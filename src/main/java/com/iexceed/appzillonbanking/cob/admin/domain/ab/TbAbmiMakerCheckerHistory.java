...
@Entity
@Table(name = "TB_ABOB_MAKER_CHECKER_HISTORY")
@IdClass(TbAbmiMakerCheckerHistoryIds.class)
public class TbAbmiMakerCheckerHistory {
	@Id
	private String id;
	...
	public TbAbmiMakerCheckerHistory() {
	}

	public TbAbmiMakerCheckerHistory(String id, String featureId, String userAction, String payload, String authStatus,
