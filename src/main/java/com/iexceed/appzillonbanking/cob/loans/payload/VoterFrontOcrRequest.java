...
@AllArgsConstructor
@NoArgsConstructor
public class VoterFrontOcrRequest {
	@Override
	public String toString() {
		return "VoterFrontOcrRequest [interfaceName=" + interfaceName + ", appId=" + appId + ", requestObj="
				+ requestObj + "]";
	}
	...
	private VoterFrontOcrRequestFields requestObj;
